 ...
 * Author: Thomas Hartmann & Rebecca Sørensen.
 */
public class HibernateConfig {
    ...
    private static Properties setDevProperties(Properties props, String DBName) {
        props.put("hibernate.connection.url", "jdbc:postgresql://db:5432/" + DBName); // services kan ændres normalt localhost
